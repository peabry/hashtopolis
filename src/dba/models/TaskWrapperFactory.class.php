...
class TaskWrapperFactory extends AbstractModelFactory {
  ...
  function createObjectFromDict($pk, $dict) {
    $o = new TaskWrapper($dict['taskWrapperId'], $dict['priority'], $dict['taskType'], $dict['hashlistId'], $dict['accessGroupId'], $dict['taskWrapperName'], $dict['isArchived'], $dict['cracked'], $dict['createdByUserId']);
    return $o;
  }
